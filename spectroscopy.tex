...
\begin{table}[H]
    \caption{Bottomonium spectrum. Masses provided in $MeV$s. Standard deviation of Deng et al.~\cite{deng-bot} and our result from PDG~\cite{pdg} are comparable and $\approx 20MeV$. (Bottomonium was provided as a test so states without experimental data were skipped)}
