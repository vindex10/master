...
\begin{align}
    ...
    \end{split} \\
    \begin{split}
    &= \sqrt{\frac{(2L_i + 1)(2L+1)}{4 \pi (2L_f + 1)}} < L_f 0 | L 0 L_i 0 > \sum_{s, s_{q}, s_{\overline{q}}} \frac{2 (-1)^{s}}{\sqrt{1+s^2}} <J \lambda| L (\lambda - s) 1 s> \times\\
...
\begin{align} \label{app:hint-mult:Ccoef-reduce}
    ...
    \begin{split}
        ...
        &\times <L_i m_i S_i s_i| J_i j_i> <S_f s_f| \frac{1}{2} s^f_{q} \frac{1}{2} s^f_{\overline{q}}> \frac{2 (-1)^{m_2}}{\sqrt{1+m_2^2}} \delta_{s^f_{q}, s^{i}_{q} + m_2} \delta_{s^f_{\overline{q}}, s^i_{\overline{q}}} <\frac{1}{2} s^i_{q} \frac{1}{2} s^i_{\overline{q}} |S_i s_i> = \\
    \end{split} \\
    \begin{split}
        &= \sqrt{\frac{(2L_i + 1)(2L+1)}{4 \pi (2L_f + 1)}} <L_i 0 L 0 | L_f 0> \sum_{\substack{m_1, m_2, m_i,\\ s_i, m_f, s_f,\\ s^i_{q}, s^{i}_{\overline{q}}, s^{f}_{q}, s^{f}_{\overline{q}}}} \frac{2 (-1)^{m_2}}{\sqrt{1+m_2^2}} <J \lambda| L m_1 1 m_2> \times\\
