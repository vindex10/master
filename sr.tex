...
\begin{table}
    ...
    \input{assets/sr-report.psi_1S.c-scr}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/srE1-report.psi_1S.c-scr}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/srELW-report.psi_1S.c-scr}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/sr-report.psi_1S.c-lin}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/srE1-report.psi_1S.c-lin}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/srELW-report.psi_1S.c-lin}
\end{table}

Following the same setting as for decay widths, we provide results for sumurules computed for bottomonium $\Upsilon(1S)$

\begin{table}[H]
    \caption{Sumrule computed for $\Upsilon(1S)$ in screened potential with multipoles up to J=8 measured in $\mu b$. Error $\sigma \approx 0.012 \mu b$ mostly comes from comparison to Deng et al. \label{tab:sr.yps_1S.b-scr}}
    \input{assets/sr-report.yps_1S.b-scr}
\end{table}

\begin{table}[H]
    \caption{Sumrule computed for $\Upsilon(1S)$ in screened potential in E1 approximation, measured in $\mu b$. Error $\sigma \approx 0.45 \mu b$ mostly comes from comparison to Deng et al. \label{tab:srE1.yps_1S.b-scr}}
    \input{assets/srE1-report.yps_1S.b-scr}
\end{table}

\begin{table}[H]
    \caption{Sumrule computed for $\Upsilon(1S)$ in screened potential in ELW approximation, measured in $\mu b$. Error $\sigma \approx 0.49 \mu b$ mostly comes from comparison to Deng et al. \label{tab:srELW.yps_1S.b-scr}}
    \input{assets/srELW-report.yps_1S.b-scr}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/sr-report.psi_2S.c-scr}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/srE1-report.psi_2S.c-scr}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/srELW-report.psi_2S.c-scr}
\end{table}

\begin{table}[H]
    \caption{Sumrule computed for $\Upsilon(2S)$ in screened potential with multipoles up to J=8 measured in $\mu b$. Error $\sigma \approx 1.01 \mu b$ comes from comparison to Deng et al \label{tab:sr.yps_2S.b-scr}}
    \input{assets/sr-report.yps_2S.b-scr}
\end{table}

\begin{table}[H]
    \caption{Sumrule computed for $\Upsilon(2S)$ in screened potential in E1 approximation, measured in $\mu b$. Error $\sigma \approx 0.58 \mu b$ comes from comparison to Deng et al \label{tab:srE1.yps_2S.b-scr}}
    \input{assets/srE1-report.yps_2S.b-scr}
\end{table}

\begin{table}[H]
    \caption{Sumrule computed for $\Upsilon(2S)$ in screened potential in ELW approximation, measured in $\mu b$. Error $\sigma \approx 0.44 \mu b$ comes from comparison to Deng et al \label{tab:srELW.yps_2S.b-scr}}
    \input{assets/srELW-report.yps_2S.b-scr}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/sr-report.psi_1_1D.c-scr}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/srE1-report.psi_1_1D.c-scr}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/srELW-report.psi_1_1D.c-scr}
\end{table}
