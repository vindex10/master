...
\begin{table}[H] 
    ...
    \begin{subfloatrow}
        \ttabbox
            ...
            {\input{assets/sr.psi_1S.c-scr}}
        \hspace{1cm}
        \ttabbox
            {\caption{E1 approximation.}}
            {\input{assets/srE1.psi_1S.c-scr}}
    \end{subfloatrow}
...
\begin{table}[H] 
    ...
    \begin{subfloatrow}
        \ttabbox
            {\caption{Multipoles up to J=8}}
            {\input{assets/sr.psi_1S.c-lin}}
        \hspace{1cm}
        \ttabbox
            {\caption{E1 approximation}}
            {\input{assets/srE1.psi_1S.c-lin}}
    \end{subfloatrow}
...
\begin{table}[H]
    ...
    \begin{subfloatrow}
        \ttabbox
            {\caption{Multipoles up to J=8}}
            {\input{assets/sr.yps_1S.b-scr}}
        \hspace{1cm}
        \ttabbox
            {\caption{E1 approximation}}
            {\input{assets/srE1.yps_1S.b-scr}}
    \end{subfloatrow}
...
\begin{table}[H]
    ...
    \begin{subfloatrow}
        \ttabbox
            {\caption{Multipoles up to J=8}}
            {\input{assets/sr.psi_2S.c-scr}}
        \hspace{1cm}
        \ttabbox
            {\caption{E1 approximation}}
            {\input{assets/srE1.psi_2S.c-scr}}
    \end{subfloatrow}
...
\begin{table}[H]
    ...
    \begin{subfloatrow}
        \ttabbox
            {\caption{Multipoles up to J=8}}
            {\input{assets/sr.yps_2S.b-scr}}
        \hspace{1cm}
        \ttabbox
            {\caption{E1 approximation}}
            {\input{assets/srE1.yps_2S.b-scr}}
    \end{subfloatrow}
...
\begin{table}[H]
    ...
    \begin{subfloatrow}
        \ttabbox
            {\caption{Multipoles up to J=8}}
            {\input{assets/sr.psi_1_1D.c-scr}}
        \hspace{1cm}
        \ttabbox
            {\caption{E1 approximation}}
            {\input{assets/srE1.psi_1_1D.c-scr}}
    \end{subfloatrow}
