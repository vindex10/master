...
According to the plan, we are in need of some model to reproduce masses and wave functions of charmonium. For the low-energy region non-relativistic quark model does well in reproducing experimental results. Here we are going to introduce the model potential based on phenomenological considerations referring to sources where it has been obtained from non-relativistic limit of QCD perturbation theory~\cite{nrqm-perturb}:
